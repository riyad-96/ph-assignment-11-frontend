    ...
    <>
      <section className="mx-auto py-12">
        <header className="mb-10">
          <h2 className="text-brand mb-2 text-xl font-semibold md:text-2xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="bg-surface grid rounded-xl p-4 shadow">
            <h3 className="text-content mb-2 text-lg font-semibold">
              Dhaka <span className="text-brand">→</span> Chittagong
            </h3>
            ...
            <Link
              to="/all-tickets"
              className="bg-brand-light text-content inline-block w-full rounded-full py-3 text-center text-sm font-semibold"
            >
              BOOK NOW
            </Link>
          </div>
          ...
          <div className="bg-surface grid rounded-xl p-4 shadow">
            <h3 className="text-content mb-2 text-lg font-semibold">
              Dhaka <span className="text-brand">→</span> Cox's Bazar
            </h3>
            <p className="text-content-light mb-4">
          ...
          <div className="bg-surface grid rounded-xl p-4 shadow">
            <h3 className="text-content mb-2 text-lg font-semibold">
              Dhaka <span className="text-brand">→</span> Sylhet
            </h3>
            <p className="text-content-light mb-4">
          ...
          <div className="bg-surface grid rounded-xl p-4 shadow">
            <h3 className="text-content mb-2 text-lg font-semibold">
              Dhaka <span className="text-brand">→</span> Rajshahi
            </h3>
            <p className="text-content-light mb-4">
      ...
      <section className="mx-auto py-12">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="bg-surface flex items-start space-x-4 rounded-lg p-6 shadow">
            ...
            <div>
              <h3 className="text-content mb-1 text-lg font-semibold">
                100% Secure Payment
              </h3>
